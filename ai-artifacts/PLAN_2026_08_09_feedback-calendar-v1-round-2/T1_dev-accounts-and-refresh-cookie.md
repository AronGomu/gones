...
- [x] commit msg draft: `fix(dev): seed local accounts and stop dropping the refresh cookie over http` — committed as `49e6155` on `feat/feedback-calendar-v1`, pushed to `origin`.
