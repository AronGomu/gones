...
const leagueListResponse = await fetch('http://127.0.0.1:5080/api/leagues?pageSize=100');
...
const leagueDetailResponse = await fetch('http://127.0.0.1:5080/api/leagues/placeholder-league');
