...
- [ ] **The commit is doc-only.** `git show --stat HEAD` lists exactly one file, `docs/RUNTIME_CONTRACT.md`, with 11 insertions and 11 deletions. No implementation file, no ADR, no `DEPLOYMENT.md`, no test file appears. If any implementation layer changed, this slice overstepped.
