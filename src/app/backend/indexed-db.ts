 ...
 *
 * IndexedDB is confined to this file and `local-live-backend.service.ts` (ADR 0021); the boundary
 * test in `server-authority-boundary.test.ts` fails if it appears anywhere else.
 */
