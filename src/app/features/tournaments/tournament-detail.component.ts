...
@Component({
  ...
  template: `
    ...
    @if (tournament(); as t) {
      ...
      @if (editing() && !titleOnlyEditing()) { <mat-card class="panel edit-banner"><mat-card-title>Unsaved tournament draft</mat-card-title><mat-card-actions align="end"><button mat-button (click)="cancelEdit()">Cancel Esc</button><button mat-flat-button color="primary" (click)="save()" [disabled]="saving()">Save {{ saveShortcutLabel }}</button></mat-card-actions></mat-card> }
