...
const registrationAndOrganizerRoutes: Routes = [
  ...
  { path: 'events/new', canActivate: [userGuard, verifiedEmailGuard, eventCreatePowerGuard], canDeactivate: [eventEditorCanDeactivate], loadComponent: () => import('./features/events/organizer-event-create.component').then((m) => m.OrganizerEventCreateComponent) },
  ...
  { path: 'organizer/events/:id/edit', canActivate: [organizerGuard, verifiedEmailGuard, powerUserGuard], canDeactivate: [eventEditorCanDeactivate], loadComponent: () => import('./features/events/organizer-event-create.component').then((m) => m.OrganizerEventCreateComponent) },
