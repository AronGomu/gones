...
const PUBLIC_GET_URLS = [
  ...
  '/api/archive/league-seasons/all',
  '/api/archive/tournaments/all',
  '/api/archive/tournaments/all?year=2026',
  '/api/archive/years',
  '/api/archive/league-seasons/season-1/tournaments',
  '/api/archive/league-seasons/season-1/result',
  '/api/archive/tournaments/t-1',
  '/api/archive/tournaments/t-1/result',
  '/api/archive/global-player-statistics',
  '/api/archive/global-player-statistics?scopeKind=season&scopeId=season-1',
  '/api/archive/global-player-statistics/all',
  '/api/formats',
  '/api/deck-archetypes'
];
