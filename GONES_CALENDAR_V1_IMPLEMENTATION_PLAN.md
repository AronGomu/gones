...
- [x] Global Rankings page: 11-col table, search/sort/page, server-only source, home card, EN/FR nav. (`npm run acceptance:matrix`: 1 proved row, `doc09-global-stats-page`; `npm run e2e:ci`)
