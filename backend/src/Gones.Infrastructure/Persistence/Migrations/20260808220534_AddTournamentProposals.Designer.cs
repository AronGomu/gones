...
namespace Gones.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260808220534_AddTournamentProposals")]
    partial class AddTournamentProposals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gones.Domain.Calendar.TournamentProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tournament_proposals");

                    b.HasIndex("DecidedByUserId")
                        .HasDatabaseName("ix_tournament_proposals_decided_by_user_id");

                    b.HasIndex("SubmittedByUserId")
                        .HasDatabaseName("ix_tournament_proposals_submitted_by_user_id");

                    b.HasIndex("Status", "ExpiresAt")
                        .HasDatabaseName("ix_tournament_proposals_status_expires_at");

                    b.ToTable("tournament_proposals", null, t =>
                        {
            ...
            modelBuilder.Entity("Gones.Domain.Calendar.TournamentProposalRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tournament_proposal_recipients");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_tournament_proposal_recipients_token_hash");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_tournament_proposal_recipients_user_id");

                    b.HasIndex("ProposalId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_tournament_proposal_recipients_proposal_id_user_id");

                    b.ToTable("tournament_proposal_recipients", null, t =>
                        {
            ...
            modelBuilder.Entity("Gones.Domain.Leagues.LeagueAggregate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_league_aggregates");

                    b.HasIndex("DocumentId")
                        .IsUnique()
                        .HasDatabaseName("ix_league_aggregates_document_id");

                    b.HasIndex("Name")
                        .HasDatabaseName("ix_league_aggregates_name");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_league_aggregates_status");

                    b.HasIndex("Version")
                        .HasDatabaseName("ix_league_aggregates_version");

                    b.HasIndex("DeletedAt", "UpdatedAt", "Id")
                        .IsDescending(false, true, false)
                        .HasDatabaseName("ix_league_aggregates_deleted_at_updated_at_id");

                    b.ToTable("league_aggregates", null, t =>
                        {
            ...
            modelBuilder.Entity("Gones.Domain.Calendar.TournamentProposal", b =>
                {
                    b.HasOne("Gones.Infrastructure.Identity.ApplicationUser", null)
                        ...
                        .HasConstraintName("fk_tournament_proposals_asp_net_users_decided_by_user_id");
                    ...
                    b.HasOne("Gones.Infrastructure.Identity.ApplicationUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tournament_proposals_asp_net_users_submitted_by_user_id");
                });

            modelBuilder.Entity("Gones.Domain.Calendar.TournamentProposalRecipient", b =>
                {
                    b.HasOne("Gones.Domain.Calendar.TournamentProposal", null)
                        .WithMany("Recipients")
                        .HasForeignKey("ProposalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tournament_proposal_recipients_tournament_proposals_proposa~");
                    ...
                    b.HasOne("Gones.Infrastructure.Identity.ApplicationUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tournament_proposal_recipients_asp_net_users_user_id");
                });
