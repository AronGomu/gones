...
namespace Gones.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260802173103_AddOrganizerParticipantManagement")]
    partial class AddOrganizerParticipantManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gones.Domain.Calendar.TournamentLifecycleEvent", b =>
                {
                    ...
                    b.HasIndex("ReminderPlanAction", "OccurredAt")
                        .HasDatabaseName("ix_tournament_lifecycle_events_reminder_plan_action_occurred_at");
