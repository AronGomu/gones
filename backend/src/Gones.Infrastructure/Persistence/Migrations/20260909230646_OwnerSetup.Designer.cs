...
namespace Gones.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909230646_OwnerSetup")]
    partial class OwnerSetup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gones.Domain.Archive.ArchiveLeague", b =>
                {
                    ...
                    b.HasKey("DocumentId")
                        .HasName("pk_archive_leagues");

                    b.HasIndex("DeletedAt", "UpdatedAt", "DocumentId")
                        .IsDescending(false, true, false)
                        .HasDatabaseName("ix_archive_leagues_deleted_at_updated_at_document_id");

                    b.ToTable("archive_leagues", null, t =>
                        {
                            t.HasCheckConstraint("ck_archive_league_version_positive", "version > 0");
                        });
                });

            modelBuilder.Entity("Gones.Domain.Archive.ArchiveLeagueSeason", b =>
                {
                    b.Property<string>("DocumentId")
                        .HasColumnType("text")
                        .HasColumnName("document_id");

                    b.Property<int>("CountsRevision")
                        .HasColumnType("integer")
                        .HasColumnName("counts_revision");
                    ...
                    b.Property<LocalDate?>("FirstTournamentDate")
                        .HasColumnType("date")
                        .HasColumnName("first_tournament_date");

                    b.Property<LocalDate?>("LastTournamentDate")
                        .HasColumnType("date")
                        .HasColumnName("last_tournament_date");
                    ...
                    b.HasKey("DocumentId")
                        .HasName("pk_archive_league_seasons");

                    b.HasIndex("LeagueId")
                        .HasDatabaseName("ix_archive_league_seasons_league_id");

                    b.HasIndex("DeletedAt", "UpdatedAt", "DocumentId")
                        .IsDescending(false, true, false)
                        .HasDatabaseName("ix_archive_league_seasons_deleted_at_updated_at_document_id");

                    b.ToTable("archive_league_seasons", null, t =>
                        {
                            t.HasCheckConstraint("ck_archive_league_season_count_dates", "(first_tournament_date IS NULL) = (last_tournament_date IS NULL) AND (first_tournament_date IS NULL OR first_tournament_date <= last_tournament_date)");

                            t.HasCheckConstraint("ck_archive_league_season_counts_non_negative", "tournament_count >= 0 AND player_count >= 0");

                            t.HasCheckConstraint("ck_archive_league_season_status", "status IN ('active', 'completed')");

                            t.HasCheckConstraint("ck_archive_league_season_version_positive", "version > 0");
                        });
                });

            modelBuilder.Entity("Gones.Domain.Archive.ArchiveTournament", b =>
                {
                    b.Property<string>("DocumentId")
                        .HasColumnType("text")
                        .HasColumnName("document_id");
                    ...
                    b.Property<LocalDate>("TournamentDate")
                        .HasColumnType("date")
                    ...
                    b.HasKey("DocumentId")
                        .HasName("pk_archive_tournaments");

                    b.HasIndex("SeasonId")
                        .HasDatabaseName("ix_archive_tournaments_season_id");

                    b.HasIndex("TournamentDate")
                        .IsDescending()
                        .HasDatabaseName("ix_archive_tournaments_tournament_date");

                    b.ToTable("archive_tournaments", null, t =>
                        {
                            t.HasCheckConstraint("ck_archive_tournament_document_metadata", "document ->> 'id' = document_id AND document ->> 'name' = name AND document ->> 'status' = status AND document ->> 'seasonId' IS NOT DISTINCT FROM season_id");

                            t.HasCheckConstraint("ck_archive_tournament_document_object", "jsonb_typeof(document) = 'object'");

                            t.HasCheckConstraint("ck_archive_tournament_document_size", "octet_length(document::text) <= 1048576");

                            t.HasCheckConstraint("ck_archive_tournament_player_count_non_negative", "player_count >= 0");

                            t.HasCheckConstraint("ck_archive_tournament_status", "status IN ('active', 'completed')");

                            t.HasCheckConstraint("ck_archive_tournament_version_positive", "version > 0");
                        });
                });
            ...
            modelBuilder.Entity("Gones.Domain.Identity.OwnerSetup", b =>
                {
                    ...
                    b.HasKey("Key")
                        .HasName("pk_owner_setups");

                    b.ToTable("owner_setups", null, t =>
                        {
                            t.HasCheckConstraint("ck_owner_setup_singleton", "key = 'owner-setup'");
                        });
                });
            ...
            modelBuilder.Entity("Gones.Domain.Persistence.WorkerMaintenanceState", b =>
                {
                    b.Property<string>("Key")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                    ...
                    b.Property<bool>("HasFailed")
                        .HasColumnType("boolean")
                        .HasColumnName("has_failed");

                    b.Property<Instant?>("LastSucceededAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_succeeded_at");

                    b.Property<Instant>("NextDueAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("next_due_at");

                    b.HasKey("Key")
                        .HasName("pk_worker_maintenance");

                    b.ToTable("worker_maintenance");
                });
            ...
            modelBuilder.Entity("Gones.Infrastructure.Persistence.PlayerStatisticsRow", b =>
                {
                    ...
                    b.HasKey("ScopeKind", "ScopeId", "PlayerName")
                    ...
                    b.ToTable("player_statistics", null, t =>
                        {
                            t.HasCheckConstraint("ck_player_statistics_scope_kind", "scope_kind IN ('global','league','season')");
                        });
                });
            ...
            modelBuilder.Entity("Gones.Domain.Archive.ArchiveLeagueSeason", b =>
                {
                    b.HasOne("Gones.Domain.Archive.ArchiveLeague", null)
                        .WithMany()
                        .HasForeignKey("LeagueId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_archive_league_seasons_archive_leagues_league_id");
                });

            modelBuilder.Entity("Gones.Domain.Archive.ArchiveTournament", b =>
                {
                    b.HasOne("Gones.Domain.Archive.ArchiveLeagueSeason", null)
                        .WithMany()
                        .HasForeignKey("SeasonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_archive_tournaments_archive_league_seasons_season_id");
                });
